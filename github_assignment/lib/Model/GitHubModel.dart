...
List<GitHubModel> gitHubModelFromJson(String str) => List<GitHubModel>.from(
    json.decode(str).map((x) => GitHubModel.fromJson(x)));

String gitHubModelToJson(List<GitHubModel> data) =>
